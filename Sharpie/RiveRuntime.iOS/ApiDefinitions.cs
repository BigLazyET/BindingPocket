...
*/[Protocol]
	...
	interface RiveMTKView : IRiveMetalDrawableView
	{
	}
	...
	interface RiveRendererView
	{
		...
		CAMetalDrawable CurrentDrawableOverride { get; set; }
...
*/[Protocol (Name = "_TtP11RiveRuntime24RiveFallbackFontProvider_")]
	...
	interface RiveFallbackFontDescriptor_RiveRuntime_Swift_349 : IRiveFallbackFontProvider
	{
...
*/[Protocol (Name = "_TtP11RiveRuntime21RiveFontWidthProvider_")]
	...
	interface RiveLogger_RiveRuntime_Swift_511
	{
		...
		void LogArtboard (RiveArtboard artboard, string name);
	}
	...
	interface RiveLogger_RiveRuntime_Swift_519
	{
		...
		void LogStateMachine (RiveStateMachineInstance stateMachine, string name);
	}
	...
	interface RiveLogger_RiveRuntime_Swift_548
	{
		...
		void LogWithViewModelInstance (RiveDataBindingViewModelInstance instance, string path, bool found);
	...
	[DisableDefaultCtor]
	interface RiveViewModel : IRiveFileDelegate, IRivePlayerDelegate, IRiveStateMachineDelegate
	{
		...
		[DesignatedInitializer]
		NativeHandle Constructor (string webURL, [NullAllowed] string animationName, RiveFit fit, RiveAlignment alignment, bool autoPlay, bool loadCdn, [NullAllowed] string artboardName);
...
*/[Protocol (Name = "_TtP11RiveRuntime18RiveWeightProvider_")]
	...
	interface UIFont_RiveRuntime_Swift_943 : IRiveFontWidthProvider
	{
	...
	[Category]
	[BaseType (typeof(UIFont))]
	interface UIFont_RiveRuntime_Swift_948 : IRiveWeightProvider
	{
	...
	[Category]
	[BaseType (typeof(UIFont))]
	interface UIFont_RiveRuntime_Swift_953 : IRiveFallbackFontProvider
	{
		// @property (readonly, nonatomic, strong) UIFont * _Nonnull fallbackFont;
		[Export ("fallbackFont", ArgumentSemantic.Strong)]
		UIFont FallbackFont { get; }
