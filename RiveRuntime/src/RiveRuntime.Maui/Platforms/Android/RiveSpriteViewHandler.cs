...
//     private MyAssetLoader? _assetLoader;
//     
...
//         
//         // _assetLoader = new MyAssetLoader();
//         // riveAnimationView.SetAssetLoader(_assetLoader);
...
//         
//         // 关键：不要在这里 Dispose 原生 Rive 视图
//         MainThread.BeginInvokeOnMainThread(() =>
//         {
//             try { platformView.Pause(); } catch { /* ignore */ }
//
//             try
//             {
//                 if (riveSpriteViewListener != null)
//                 {
//                     // 如果库有 Unregister/RemoveListener 方法，优先调用
//                     platformView.UnregisterListener(riveSpriteViewListener);
